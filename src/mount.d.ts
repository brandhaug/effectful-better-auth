...
import { HttpRouter, type HttpServerError, HttpServerRequest, HttpServerResponse } from 'effect/unstable/http';
 ...
 */
export declare const toHttpEffect: <O extends BetterAuthOptions>(tag: Tag<O>) => Effect.Effect<HttpServerResponse.HttpServerResponse, HttpServerError.RequestError, HttpServerRequest.HttpServerRequest | Service<O>>;
/**
 ...
 */
export declare const route: <O extends BetterAuthOptions>(tag: Tag<O>, options?: {
