...
export declare const effectApi: <Api extends Record<string, unknown>>(
	api: Api
) => EffectApi<Api>
export declare const wrap: <const O extends BetterAuthOptions>(
	options: O
) => {
	readonly api: EffectApi<
		import('better-auth').InferAPI<
			import('better-auth').UnionToIntersection<
				O['plugins'] extends (infer T)[]
					? T extends import('better-auth').BetterAuthPlugin
						? T extends {
								endpoints: infer E
							}
							? E
					...
					: {}
			> extends infer T_1
				? T_1 extends import('better-auth').UnionToIntersection<
						O['plugins'] extends (infer T_2)[]
							? T_2 extends import('better-auth').BetterAuthPlugin
								? T_2 extends {
										endpoints: infer E_1
									}
									? E_1
					...
					? T_1 extends unknown
						? import('better-auth').Prettify<
								({
									readonly ok: import('better-call').StrictEndpoint<
										'/ok',
										{
											method: 'GET'
											metadata: {
									...
									>
									readonly error: import('better-call').StrictEndpoint<
										'/error',
										{
											method: 'GET'
											metadata: {
										...
										Response
									>
									readonly signInSocial: import('better-call').StrictEndpoint<
										'/sign-in/social',
										{
											method: 'POST'
											operationId: string
											body: import('zod').ZodObject<
												{
													...
													provider: import('zod').ZodType<
														...
														>
													>
													disableRedirect: import('zod').ZodOptional<
														...
														import('zod').ZodObject<
															{
																...
																nonce: import('zod').ZodOptional<
																	import('zod').ZodString
																>
																accessToken: import('zod').ZodOptional<
																	import('zod').ZodString
																>
																refreshToken: import('zod').ZodOptional<
																	import('zod').ZodString
																>
																expiresAt: import('zod').ZodOptional<
																	import('zod').ZodNumber
																>
																user: import('zod').ZodOptional<
																	import('zod').ZodObject<
																		{
																			name: import('zod').ZodOptional<
																				import('zod').ZodObject<
																					{
																						firstName: import('zod').ZodOptional<
																							import('zod').ZodString
																						>
																						lastName: import('zod').ZodOptional<
																							import('zod').ZodString
																						>
																					},
													...
													>
													requestSignUp: import('zod').ZodOptional<
														import('zod').ZodBoolean
													>
													loginHint: import('zod').ZodOptional<
														import('zod').ZodString
													>
													additionalData: import('zod').ZodOptional<
													...
													returned: {
														...
														user?:
															| ({
															  ...
															  } & import('better-auth').InferDBFieldsFromOptions<
																	O['user']
															  > &
																	import('better-auth').InferDBFieldsFromPlugins<
																		'user',
																		O['plugins']
																	> extends infer T_3_1
																	? { [K_1 in keyof T_3_1]: T_3_1[K_1] }
																	: never)
															| undefined
													}
												}
										...
										| {
												...
												> &
													import('better-auth').InferDBFieldsFromPlugins<
														...
														O['plugins']
													> extends infer T_4
													? { [K_1_1 in keyof T_4]: T_4[K_1_1] }
													: never
										  }
									>
									readonly callbackOAuth: import('better-call').StrictEndpoint<
										'/callback/:id',
										{
											method: ('GET' | 'POST')[]
											operationId: string
											body: import('zod').ZodOptional<
												import('zod').ZodObject<
													{
														code: import('zod').ZodOptional<
															import('zod').ZodString
														>
														error: import('zod').ZodOptional<
															import('zod').ZodString
														>
														device_id: import('zod').ZodOptional<
															import('zod').ZodString
														>
														error_description: import('zod').ZodOptional<
															import('zod').ZodString
														>
														state: import('zod').ZodOptional<
															import('zod').ZodString
														>
														user: import('zod').ZodOptional<
															import('zod').ZodString
										...
										never
									>
									readonly getSession: import('better-call').StrictEndpoint<
										'/get-session',
										{
											method: ('GET' | 'POST')[]
											operationId: string
												...
												import('zod').ZodObject<
													{
														...
														>
														disableRefresh: import('zod').ZodOptional<
															import('zod').ZodCoercedBoolean<unknown>
														>
													},
													import('zod/v4/core').$strip
										...
										},
										{
											...
											> &
												import('better-auth').InferDBFieldsFromPlugins<
													...
													O['plugins']
												> extends infer T_6
												? { [K_1_2 in keyof T_6]: T_6[K_1_2] }
												: never
										} | null
									>
									readonly signOut: import('better-call').StrictEndpoint<
										'/sign-out',
										{
											method: 'POST'
											operationId: string
									...
									>
									readonly signUpEmail: import('better-call').StrictEndpoint<
										'/sign-up/email',
										{
											method: 'POST'
											operationId: string
											...
											metadata: {
												...
												$Infer: {
													...
													} & import('better-auth').InferDBFieldsFromPluginsInput<
														'user',
														O['plugins']
													> &
														import('better-auth').InferDBFieldsFromOptionsInput<
															O['user']
														>
													returned: {
														token: string | null
										...
										| {
												...
												> &
													import('better-auth').InferDBFieldsFromPlugins<
														...
														O['plugins']
													> extends infer T_9
													? { [K_1_5 in keyof T_9]: T_9[K_1_5] }
													: never
										  }
									>
									readonly signInEmail: import('better-call').StrictEndpoint<
										'/sign-in/email',
										{
											method: 'POST'
											operationId: string
													...
													returned: {
														...
														> &
															import('better-auth').InferDBFieldsFromPlugins<
																...
																O['plugins']
															> extends infer T_10
															? { [K_1_6 in keyof T_10]: T_10[K_1_6] }
															: never
													}
												}
												openapi: {
										...
										},
										{
											...
											> &
												import('better-auth').InferDBFieldsFromPlugins<
													...
													O['plugins']
												> extends infer T_11
												? { [K_1_7 in keyof T_11]: T_11[K_1_7] }
												: never
										}
									>
									readonly resetPassword: import('better-call').StrictEndpoint<
										'/reset-password',
										{
											method: 'POST'
											operationId: string
									...
									>
									readonly verifyPassword: import('better-call').StrictEndpoint<
										'/verify-password',
										{
											method: 'POST'
											body: import('zod').ZodObject<
									...
									>
									readonly verifyEmail: import('better-call').StrictEndpoint<
										'/verify-email',
										{
											method: 'GET'
											operationId: string
									...
									>
									readonly sendVerificationEmail: import('better-call').StrictEndpoint<
									...
									>
									readonly changeEmail: import('better-call').StrictEndpoint<
										'/change-email',
										{
											method: 'POST'
											body: import('zod').ZodObject<
									...
									>
									readonly changePassword: import('better-call').StrictEndpoint<
										'/change-password',
										{
											method: 'POST'
											operationId: string
											body: import('zod').ZodObject<
												{
													...
													revokeOtherSessions: import('zod').ZodOptional<
														import('zod').ZodBoolean
													>
												},
												import('zod/v4/core').$strip
									...
									>
									readonly setPassword: import('better-call').StrictEndpoint<
										string,
										{
											method: 'POST'
											body: import('zod').ZodObject<
									...
									>
									readonly updateSession: import('better-call').StrictEndpoint<
										'/update-session',
										{
											method: 'POST'
											operationId: string
											body: import('zod').ZodRecord<
												import('zod').ZodString,
												import('zod').ZodAny
											>
											use: ((
											...
											metadata: {
												$Infer: {
													body: Partial<
														import('better-auth').AdditionalSessionFieldsInput<O>
													>
												}
												openapi: {
													operationId: string
									...
									>
									readonly updateUser: import('better-call').StrictEndpoint<
										'/update-user',
										{
											method: 'POST'
											operationId: string
											...
											metadata: {
												$Infer: {
													body: Partial<
														import('better-auth').AdditionalUserFieldsInput<O>
													> & {
									...
									>
									readonly deleteUser: import('better-call').StrictEndpoint<
										'/delete-user',
										{
											method: 'POST'
											use: ((
									...
									>
									readonly requestPasswordReset: import('better-call').StrictEndpoint<
										'/request-password-reset',
										{
											...
											body: import('zod').ZodObject<
												{
													email: import('zod').ZodEmail
													redirectTo: import('zod').ZodOptional<
														import('zod').ZodString
													>
												},
												import('zod/v4/core').$strip
									...
									>
									readonly requestPasswordResetCallback: import('better-call').StrictEndpoint<
										...
										never
									>
									readonly listSessions: import('better-call').StrictEndpoint<
										'/list-sessions',
										{
											method: 'GET'
											operationId: string
										...
										import('better-auth').Prettify<
											...
											> &
												import('better-auth').InferDBFieldsFromPlugins<
													...
													O['plugins']
												> extends infer T_12
												? { [K_2_1 in keyof T_12]: T_12[K_2_1] }
												: never
										>[]
									>
									readonly revokeSession: import('better-call').StrictEndpoint<
										'/revoke-session',
										{
											method: 'POST'
											body: import('zod').ZodObject<
									...
									>
									readonly revokeSessions: import('better-call').StrictEndpoint<
										'/revoke-sessions',
										{
											method: 'POST'
											use: ((
									...
									>
									readonly revokeOtherSessions: import('better-call').StrictEndpoint<
									...
									>
									readonly linkSocialAccount: import('better-call').StrictEndpoint<
										'/link-social',
										{
											method: 'POST'
											requireHeaders: true
									...
									>
									readonly listUserAccounts: import('better-call').StrictEndpoint<
										'/list-accounts',
										{
											method: 'GET'
											use: ((
									...
									>
									readonly deleteUserCallback: import('better-call').StrictEndpoint<
									...
									>
									readonly unlinkAccount: import('better-call').StrictEndpoint<
										'/unlink-account',
										{
											method: 'POST'
											body: import('zod').ZodObject<
												{
													...
													accountId: import('zod').ZodOptional<
														import('zod').ZodString
													>
												},
												import('zod/v4/core').$strip
									...
									>
									readonly refreshToken: import('better-call').StrictEndpoint<
										'/refresh-token',
										{
											method: 'POST'
											body: import('zod').ZodObject<
									...
									>
									readonly getAccessToken: import('better-call').StrictEndpoint<
										'/get-access-token',
										{
											method: 'POST'
											body: import('zod').ZodObject<
									...
									>
									readonly accountInfo: import('better-call').StrictEndpoint<
										'/account-info',
										{
											method: 'GET'
											metadata: {
												...
												import('zod').ZodObject<
													{
														accountId: import('zod').ZodOptional<
															import('zod').ZodString
														>
														providerId: import('zod').ZodOptional<
															import('zod').ZodString
														>
														userId: import('zod').ZodOptional<
															import('zod').ZodString
									...
									? {
											[
												K in keyof T_3 as K extends keyof T_1 ? never : K
											]: T_3[K]
										}
									: never) &
									T_1
...
declare const AuthP_base: Context.ServiceClass<
	AuthP,
	'proto/AuthP',
	{
		readonly api: EffectApi<
						...
						readonly updateSession: import('better-call').StrictEndpoint<
							'/update-session',
							{
								...
								metadata: {
									$Infer: {
										body: Partial<
											import('better-auth').AdditionalSessionFieldsInput<{
												secret: string
												baseURL: string
												emailAndPassword: {
													enabled: true
												...
												plugins: [
													{
														...
														endpoints: {
															signInUsername: import('better-call').StrictEndpoint<
																'/sign-in/username',
																{
																	method: 'POST'
																	body: import('zod').ZodObject<
															...
															>
															isUsernameAvailable: import('better-call').StrictEndpoint<
														...
														options:
															| import('better-auth/plugins/username').UsernameOptions
															| undefined
														$ERROR_CODES: {
														...
														hooks: {
															after: {
																...
																handler: (
																	...
																	| import('better-auth/plugins/admin').SessionWithImpersonatedBy[]
																	| undefined
																>
															}[]
														}
