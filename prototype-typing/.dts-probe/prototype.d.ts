...
declare const BetterAuthApiError_base: Schema.Class<
	BetterAuthApiError,
	Schema.TaggedStruct<
		'BetterAuthApiError',
		{
...
export declare const make: <const O extends BetterAuthOptions>(
	options: O
) => Effect.Effect<InstanceOf<O>>
declare const AuthA_base: Context.ServiceClass<
	AuthA,
	'proto/AuthA',
							...
							user: {
								create: {
									before(
										...
										context: import('better-auth').GenericEndpointContext | null
									): Promise<
										| {
												data: {
													username: string
...
export declare const service: <const O extends BetterAuthOptions>(
	id: string,
	options: O
) => {
	readonly Tag: Context.Service<
		import('better-auth').Auth<O>,
		import('better-auth').Auth<O>
	>
	readonly layer: Layer.Layer<import('better-auth').Auth<O>, never, never>
	readonly call: <A>(
		f: (api: InstanceOf<O>['api']) => Promise<A>
	) => Effect.Effect<A, BetterAuthApiError, import('better-auth').Auth<O>>
}
